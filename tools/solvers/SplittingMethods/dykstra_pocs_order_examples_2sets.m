...
plot(x_pocs(1,:),x_pocs(2,:),'-ok','LineWidth',3);hold on;
...
title('')
legend('POCS 1','Dykstra','Location','NorthWest')
...
plot(x_pocs2(1,:),x_pocs2(2,:),'-ok','LineWidth',3);hold on;
plot(out2(:,1),out2(:,2),'-.^r','LineWidth',2)
plot(sq(:,1),sq(:,2),'b','LineWidth',3);hold on
h=ezplot('x.^2 + y.^2=9',[1 3]);set(h, 'Color', 'b','LineWidth',2);hold on
title('')
legend('POCS 2','Dykstra','Location','NorthWest');
axis([1.8 2.6 1.8 3.1])
