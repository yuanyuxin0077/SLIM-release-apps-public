...
%
% <https://www.slim.eos.ubc.ca/node/6620 [2]> T. van Leeuwen and F.J. Herrmann - Fast Waveform inversion without
% source-encoding, Geophysical Prospecting, submitted
%
% <https://www.slim.eos.ubc.ca/node/6610 [3]> A.Y. Aravkin, T. van Leeuwen and F.J. Herrmann - Source estimation
% for frequency-domain FWI with robust penalties, EAGE Expanded abstracts
% 2012.
% 
% <https://www.slim.eos.ubc.ca/content/unified-2d3d-software-environment-large-scale-time-harmonic-full-waveform-inversion [4]> C. Da Silva, F.J. Herrmann - A unified 2D/3D software environment for large scale time-harmonic full waveform inversion.
%
